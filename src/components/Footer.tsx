      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">Astrobot AI</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/chat" className="text-gray-300 hover:text-blue-400 transition-colors duration-300">
                  Chat
                </Link>
              </li>
              <li>
                <Link href="/support" className="text-gray-300 hover:text-blue-400 transition-colors duration-300">
                  Support
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-sm text-center text-gray-400">
          © {new Date().getFullYear()} Astrobot AI. All rights reserved.
        </div>
      </div>
    </footer>
  );
